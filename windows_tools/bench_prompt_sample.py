...
# zip on any box.
#
# License: PSF License (https://docs.python.org/3/license.html). Redistribution
# of unmodified CPython stdlib source is permitted under the PSF Agreement.
#
# Why this file: structurally rich (classes, methods, decorators, generators,
# dispatch tables) so the model has to actually summarize it; large enough to
# put real KV-cache pressure on the prefill path; well-known so users can
# eyeball quality of the summary.
