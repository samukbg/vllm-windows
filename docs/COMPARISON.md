...
| **This project (Blackwell zip on 5090)** | patched vLLM 0.20.0+cu132.devnen.1, native Windows | **124.8** (rtx5090_speed, ctx 120k, MTP n=6) | yes, MTP n=3 to n=6 | yes, OpenAI + Anthropic, baked in | yes | TUI |
